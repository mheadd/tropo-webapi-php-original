...
public function record($record) {
  if(!is_object($record) && is_array($record)) {
    ...
    $record = new Record($attempts, $bargein, $beep, $choices, $format, $maxSilence, $maxTime, $method, $password, $required, $say, $timeout, $transcription, $username, $url, $voice);
  }
...
class Record extends BaseClass {
  ...
  * @param string $url
  */
public function __construct($attempts=NULL, $bargein=NULL, $beep=NULL, Choices $choices=NULL, $format=NULL, $maxSilence=NULL, $maxTime=NULL, $method=NULL, $password=NULL, $required=NULL, $say=NULL, $timeout=NULL, Transcription $transcription=NULL, $username=NULL, $url=NULL, $voice=NULL) {
  $this->_attempts = $attempts;
  $this->_bargein = $bargein;
  $this->_beep = $beep;
  $this->_choices = isset($choices) ? sprintf($choices) : null;
